...
const ITEM_WIDTH = SCREEN_WIDTH - 10 >> 1;
    ...
    const renderTitle = () => {
        return (
            <View style={styles.titleLayout}>
                ...
                <Image source={icon_orders} style={styles.menuIcon} />
            ...
            <View style={styles.item}>
                ...
                <Text style={styles.prefix}>
                    ...
                    <Text style={styles.priceTxt}>
                        {item.price}  {!!item.originPrice && <Text style={styles.originTxt}>原价:￥{item.originPrice}</Text>}
                    </Text>
                </Text>
            </View>
        )
